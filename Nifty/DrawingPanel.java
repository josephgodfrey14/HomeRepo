 ...
 *IMPORTANT* Note to students: DO NOT modify this file!!!
  ...
  briefly below, and I will provide some example code for you 
  when the time seems right.
 
*/


// NOTE: This file was updated slightly by Dr. Stonedahl to include an easy/direct 
// (non-event-based) methods for getting mouse and mouse click coordinates.
// (Not needed for Pointillism assignment, but will surely be useful for some final projects!)
//
// Specifically, I added these methods:
//
...
public final class DrawingPanel extends FileFilter
    ...
    */
    ...
    private Queue<KeyEvent> keyInputQueue = new LinkedList<KeyEvent>();
