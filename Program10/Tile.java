...
public class Tile implements Comparable<Tile> {
	...
	public int compareTo(Tile tile) {
		...
		int tileArea = tile.getWidth() * tile.getHeight();
		return (thisArea-tileArea);
	}
